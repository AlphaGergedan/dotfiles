...
lsp_zero.on_attach(function(client, bufnr)
  ...
  vim.keymap.set("n", "<S-Tab>", function() vim.lsp.buf.signature_help() end, { noremap = true, silent = true })
  vim.keymap.set("i", "<S-Tab>", function() vim.lsp.buf.signature_help() end, { noremap = true, silent = true })
